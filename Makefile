...
smoke-mock-lifecycle-help:
	...
	@echo ""
	@echo "Terminal 1 (paragraph-summary-service, from repository root):"
	...
	@echo ""
	@echo "Terminal 2 (backend remote mode, from repository root):"
...
canary-gemini-batch-help:
	...
	@echo ""
	@echo "Terminal 1 (paragraph-summary-service configured for live Gemini, from repository root):"
	@echo "  # NOTE: model gemini-3.1-flash-lite is a manual canary override, not the service default."
